...
export default function RideForm() {
  ...
  const [formData, setFormData] = useState({
    pickupLocation: '',
    dropoffLocation: '',
    distanceMiles: ' ',  // kept his space default
  });
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {aiLoading && (
        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-600">🤖 Getting AI ride summary...</p>
        </div>
      )}

      {aiSummary && (
        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm font-semibold text-blue-700">🤖 AI Ride Assistant</p>
          <p className="text-sm text-blue-600 mt-1">{aiSummary}</p>
        </div>
      )}
